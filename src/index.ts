...
class mshospitalintegrationService {
  ...
  private initializeRoutes(): void {
    ...
    this.app.use('/api/v1/hospitals', hospitalRoutes);

    // Root endpoint
    this.app.get('/', (req, res) => {
      res.json({
        service: 'ms-hospital-integration Service',
        version: '1.0.0',
        status: 'running',
        timestamp: new Date().toISOString(),
  ...
  private initializeSwagger(): void {
    const options = {
      definition: {
        openapi: '3.0.0',
        info: {
          title: 'ms-hospital-integration API',
          version: '1.0.0',
          description: 'API para ms-hospital-integration',
          contact: {
            name: 'Lazarus Team',
    ...
    this.app.use('/api-docs', swaggerUi.serve, swaggerUi.setup(specs, {
      ...
      customSiteTitle: 'ms-hospital-integration API Documentation'
    }));
  }
  ...
  public async start(): Promise<void> {
    try {
      ...
      this.app.listen(this.port, '0.0.0.0', () => {
        logger.info(`ms-hospital-integration service running on port ${this.port}`);
  ...
  public async stop(): Promise<void> {
    logger.info('Stopping ms-hospital-integration service...');
    process.exit(0);
  }
}

// Start the service
const service = new mshospitalintegrationService();
service.start();
